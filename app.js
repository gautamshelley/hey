	...
	switch (action) {
		...
		case "details-application":
			if (isDefined(contexts[0]) && contexts[0].name == 'job_application' && contexts[0].parameters){
				...
				let phone_number = ( isDefined(contexts[0].parameters['phone-no'])&&contexts[0].parameters['phone-no'])? contexts[0].parameters['phone-no'] :'';
				...
				if( phone_number != '' && user_name != '' && previous_job != '' && years_of_experience != '' && job_vacancy != '') {
					...
					let emailContent = 'A new job enquiry from' +'<b>'+ user_name+'</b>' + 
														 '.<br>for the job' + '<b>'+ job_vacancy +'</b>' + 
														 '.<br> Previous Job postion' + '<b>' + previous_job +'</b>' + 
														 '.<br>Year of experience' + '<b>' + years_of_experience +'</b>' +
														 '.<br>Phone number' + '<b>' + phone_number +'</b>' ;
	...
	nodemailer.createTestAccount((err, account) => {
	    ...
	    let transporter = nodemailer.createTransport({
	      ...
	      //   secure: false,
			    // // service:'gmail',
			    // auth: {
			    //     // user: 'lakshaysaini2013@gmail.com',
			    //     // pass: '9837575474'
			    //     user: 'nca4vuikanzur4d2@ethereal.email',
			    //     pass: 'bUq7yhBMjpcs7feNAN'
			    // }
			    host: 'server126.web-hosting.com',
			    port: 465,
			    secure: true, // true for 465, false for other ports
			    auth: {
			        user: 'contact@triny.io', // generated ethereal user
			        pass: 'Gautamarshabh8'  // generated ethereal password
			    }
			});

	    // setup email data with unicode symbols
	    let mailOptions = {
	        from: 'contact@triny.io', // list of receivers
	        to: 'contact@triny.io', // list of receivers
